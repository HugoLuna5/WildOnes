        ...
        collection.findOne({ dname: dname }, function (err, user) {
          ...
          res.send(
            "<html><title>Welcome to " +
              fullname +
              '!</title><link rel="stylesheet" type="text/css" href="/css/stylev2.css?cacheVer=v1"><script type="text/javascript" src="/js/events.js?x"></script><div id="nav"><ul><li><a href="/help">Help</a></li><li class="logo"><img src="/img/logo.png"></li><li style="float:right"></ul></div><center><div class="textasd" style="color:#FFF;margin-top:90px;"><h3>Congrats!<br> Welcome, ' +
              dname +
              '.<br> You are now registered.<br></h3><br><div class="play-now"><a href="/" title="Play now!"><img src="/img/es/1.png" alt="PLAY NOW!" width="107" height="53"></a></div></body></html>'
          );
...
app.use(
  "/privatewolswf/publicV1.swf",
  express.static(__dirname + "/privatewolswf/publicV1.swf")
);
app.use("/auth-des", express.static(__dirname + "/auth-des"));
app.use("/submit-bug", express.static(__dirname + "/submit-bug"));
app.use("/assets", express.static(__dirname + "/assets"));
app.use(
  "/holiday_promo_treat_2016",
  express.static(__dirname + "/holiday_promo_treat_2016.html")
);
