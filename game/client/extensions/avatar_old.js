...
class Avatar extends Physical{
	...
	initialize(){
		...
		this.properties = this.parent.WOL.petsObj[this.chassis];
		this.drowningProperties = this.parent.WOL.weaponsObj["drowning"];
		this.superjumpProperties = this.parent.WOL.weaponsObj["superjump"];
		this.climbProperties = this.parent.WOL.weaponsObj["climb"];
	...
	move(){
		...
		if(this.Y > this.parent.WOL.config["gameHeight"] + 10)
			this.hp = 0;
		//implement water
	}
